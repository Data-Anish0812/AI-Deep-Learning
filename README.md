...
This project focuses on **Fake News Prediction** by leveraging machine learning models to classify news articles as real or fake. The workflow includes extensive text preprocessing steps such as tokenization, stopword removal, stemming/lemmatization, and TF-IDF vectorization to transform raw text into meaningful numerical features. Multiple models, including Logistic Regression, Artificial Neural Network (ANN), and Random Forest, were trained and evaluated for their performance, with a focus on accuracy and generalization. The project demonstrates end-to-end implementation, starting from data cleaning and feature engineering to model building and evaluation, providing an effective pipeline for detecting misinformation.
